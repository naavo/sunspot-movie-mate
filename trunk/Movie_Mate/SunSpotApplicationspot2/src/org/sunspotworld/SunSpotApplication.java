...
public class SunSpotApplication extends MIDlet implements ISwitchListener {
   ...
   String ourAddress = System.getProperty("IEEE_ADDRESS");
    ...
    public void demoBubbleLevel() {
        ...
        leds.setColor(LEDColor.WHITE);  // set them to be blue when lit
        ...
        while (true) {
            try {
                ...
                double ax = accel.getAccelX();
                  ...
                  if (ax >= 1.1) {
                    System.out.println(" acceleration above threshold : " + ax+" sending 9");
                    dg.reset();
                    dg.writeInt(9);
                    rCon.send(dg);
                    Utils.sleep(1000);
                 ...
                 if (offset < -3) {
                    ...
                    dg.reset();
                    dg.writeInt(5);
                    System.out.println(" Offset greater than 3 : Sending 5");
                    rCon.send(dg);
                    Utils.sleep(1000);
                }
               else if (offset > 3) {
                    ...
                    dg.reset();
                    dg.writeInt(6);
                    System.out.println(" Offset greater than 3 : Sending 6");
                    rCon.send(dg);
                    Utils.sleep(1000);
                }
    ...
    public void initialize()
        ...
        public void switchPressed(ISwitch sw)
        {
            ...
            try{
                if (sw == sw1)
                {
                        System.out.println("sw1isClosed. Send 4 to exit");
                    dg.reset();
                    dg.writeInt(4);
                    rCon.send(dg);
                }
                ...
                {
                        System.out.println("sw2isClosed. Send 8 to mute");
                        dg.reset();
                    dg.writeInt(8);
                    rCon.send(dg);
                }
